...
class CandidatePromisePolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\CandidatePromise  $candidatePromise
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, CandidatePromise $candidatePromise)
    {
        return true;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, CandidatePromise $candidatePromise)
    {
        return $this->checkAdminAndCandidate($user, $candidatePromise->candidate_id);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, CandidatePromise $candidatePromise)
    {
        return $this->checkAdminAndCandidate($user, $candidatePromise->candidate_id);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, CandidatePromise $candidatePromise)
    {
        return $this->checkAdminAndCandidate($user, $candidatePromise->candidate_id);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, CandidatePromise $candidatePromise)
    {
        return false;
    }
}
