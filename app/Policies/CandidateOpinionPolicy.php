...
class CandidateOpinionPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\CandidateOpinion  $candidateOpinion
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, CandidateOpinion $candidateOpinion)
    {
        return true;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, CandidateOpinion $candidateOpinion)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, CandidateOpinion $candidateOpinion)
    {
        return $this->checkAdminAndCandidate($user, $candidateOpinion->candidate_id);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, CandidateOpinion $candidateOpinion)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, CandidateOpinion $candidateOpinion)
    {
        return $user->hasRole('admin');
    }
