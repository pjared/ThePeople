...
class CandidatePhotoPolicy
{
    ...
    private function checkAdminAndCandidate($user, $candidate_id) :bool
    {
        ...
        if($user->hasRole('admin')) {
            ...
            // if(Candidate::find($candidate_id)->manual_candidate) {
                // return true;
            // }
            return true;
        }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\CandidatePhoto  $candidatePhoto
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, CandidatePhoto $candidatePhoto)
    {
        return true;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, CandidatePhoto $candidatePhoto)
    {
        return $this->checkAdminAndCandidate($user, $candidatePhoto->candidate_id);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, CandidatePhoto $candidatePhoto)
    {
        return $this->checkAdminAndCandidate($user, $candidatePhoto->candidate_id);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, CandidatePhoto $candidatePhoto)
    {
        return $this->checkAdminAndCandidate($user, $candidatePhoto->candidate_id);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, CandidatePhoto $candidatePhoto)
    {
