...
class CampaignVideoPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\CampaignVideo  $campaignVideo
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, CampaignVideo $campaignVideo)
    {
        return true;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, CampaignVideo $campaignVideo)
    {
        return $this->checkAdminAndCandidate($user, $campaignVideo->candidate_id);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, CampaignVideo $campaignVideo)
    {
        return $this->checkAdminAndCandidate($user, $campaignVideo->candidate_id);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, CampaignVideo $campaignVideo)
    {
        return $this->checkAdminAndCandidate($user, $campaignVideo->candidate_id);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, CampaignVideo $campaignVideo)
    {
        return false;
    }
}
