...
class CandidateStancePolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\CandidateStance  $candidateStance
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, CandidateStance $candidateStance)
    {
        return true;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, CandidateStance $candidateStance)
    {
        return $this->checkAdminAndCandidate($user, $candidateStance->candidate_id);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, CandidateStance $candidateStance)
    {
        return $this->checkAdminAndCandidate($user, $candidateStance->candidate_id);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, CandidateStance $candidateStance)
    {
        return $this->checkAdminAndCandidate($user, $candidateStance->candidate_id);
    }
