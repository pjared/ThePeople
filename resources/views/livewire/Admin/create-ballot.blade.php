                    ...
                    <div class="flex flex-col background-card w-11/12 items-center gap-2">
                        ...
                        <div class="flex-row w-11/12">
                            <div class="form-control w-1/2 max-w-xs">
                                ...
                                <input type="text" wire:model="new_location.state" class="input input-bordered max-w-xs" />
                            </div>
                            ...
                            <div class="form-control w-full max-w-xs">
                                ...
                                <input type="text" wire:model="new_location.name" class="input input-bordered w-3/4 max-w-xs" />
                            </div>
                            ...
                            <div class="form-control w-full max-w-xs">
                                ...
                                <input type="text" wire:model="new_location.type" class="input input-bordered w-3/4 max-w-xs" />
                            </div>
                ...
                <form class="flex flex-col gap-6 background-card items-center" wire:submit.prevent="createOffice">
                    ...
                    <div class="flex-row">                
                        <div class="form-control w-full max-w-xs">
                            ...
                            <input type="text" wire:model.defer="new_position.name" class="input input-bordered w-3/4 max-w-xs" />
                        </div>
                        ...
                        <div class="flex flex-row">
                            <div class="form-control w-full max-w-xs">
                                ...
                                <input type="number" wire:model.defer="new_position.years_per_term" class="input input-bordered w-1/2 max-w-xs" />
                            </div>
                            ...
                            <div class="form-control w-full max-w-xs">
                                ...
                                <input type="number" wire:model.defer="new_position.term_limits" class="input input-bordered w-1/2 max-w-xs" />
                            </div>
                            @error('new_position.term_limits') <span class="error">{{ $message }}</span> @enderror
                        </div>  
                    </div>
                        ...
                        <div class="flex-row w-11/12">
                            <div class="flex flex-row">
                                <div class="form-control w-full max-w-xs">
                                    ...
                                    <input type="number" wire:model.defer="new_ballot.location_id" class="input input-bordered w-11/12 max-w-xs" />
                                </div>
                                ...
                                <div class="form-control w-full max-w-xs">
                                    ...
                                    <input type="number" wire:model.defer="new_ballot.office_id" class="input input-bordered w-11/12 max-w-xs" />
                                </div>
                            ...
                            <div class="form-control w-full max-w-xs">
                                ...
                                <input type="date" wire:model.defer="new_ballot.voting_date" class="input input-bordered w-fit" />
                            </div>
