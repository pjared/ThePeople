...
class USSenateSeeder extends Seeder
{
    public $candidates = [
        [
            'candidate' =>[
                ...
                'sources' => 'https://www.lee.senate.gov/, https://www.britannica.com/biography/Mike-Lee, https://en.wikipedia.org/wiki/Mike_Lee',
            ],

            'personal_education' => [
                [
                    'school_name' => 'Brigham Young University',
                    'degree_field' => 'Political Science',
                    'degree_type' => 'Bachelors',
                    'year_received' => 1994,
                ],
                [
                    'school_name' => 'Brigham Young University Law School',
                    'degree_field' => 'Law',
                    'degree_type' => '(unknown)',
                    'year_received' => 1997,
                ],
            ...
            'background' => [
                [
                    'name' => 'Attorney',
                    'description' => 'Lee spent several years as an attorney with the law firm Sidley & Austin specializing in appellate and Supreme Court litigation',
                    'year_start' => 1999,
                    'year_end' => 2002,
                ],
                [
        ...
        [
            'candidate' =>[
                ...
                'sources' => 'https://evanmcmullin.com/, https://en.wikipedia.org/wiki/Evan_McMullin',
            ],
            ...
            'personal_education' => [
                [
                    'school_name' => 'Brigham Young University',
                    'degree_field' => 'International Law and Diplomacy',
                    'degree_type' => 'Bachelors',
                    'year_received' => 2001,
                ],
                [
                    'school_name' => 'University of Pennsylvania Wharton School of Business',
            ...
            'background' => [
                [
                    'name' => 'CIA Operations Officer',
                    'description' => 'He spent the next decade working overseas on counterterrorism and intelligence operations as an operations officer with the National Clandestine Service in the Middle East, North Africa, and South Asia.',
                    'year_start' => 2003,
                    'year_end' => 2010,
                ],
                [
                    'name' => 'Senior Adviser on National Security Issues for Congress',
                    'description' => 'advising Republicans and Democrats in Congress on national security and other issues ',
                    'year_start' => 2013,
                    'year_end' => 2016,
                ],
                [
                    'name' => 'Co-Founder, Stand Up Republic',
                    'description' => 'A 501(c)(4) nonprofit organization which led efforts across the country to unite Republicans and Democrats against extremist movements and politicians in defense of American democracy.',
                    'year_start' => 2003,
                    'year_end' => 2010,
                ],
            ],
        ...
        [
            ...
            'personal_education' => [
                [
                    'school_name' => 'Crowder College',
                    'degree_field' => 'Alternative Energy and Physics',
                    'degree_type' => 'Associates',
                    'year_received' => 2011,
                ],
                [
                    'school_name' => 'Missouri State University',
                    'degree_field' => 'Physics',
                    'degree_type' => 'Bachelors',
                    'year_received' => 2013,
                ],
                [
                    'school_name' => 'The University of Utah',
                    'degree_field' => 'Physics',
                    'degree_type' => 'Ph.D',
                    'year_received' => 1901,
                ],
    ...
    public function run()
    {
        ...
        $education_opinion = ControversialOpinion::create([
            'name' => 'Improving Education',
            'description' => 'The candidate\'s opinions for improvements of the education system',
            'votes' => 1000,
        ]);
        $healthcare_opinion = ControversialOpinion::create([
            'name' => 'Improving Health Care',
            'description' => 'The candidate\'s opinions for improvements of the health care system',
            'votes' => 1000,
        ]);
        $security_opinion = ControversialOpinion::create([
            'name' => 'National Security',
            'description' => 'National Security is how the candidate intends to address foreign and domestic concerns',
            'votes' => 1000,
        ]);
        $inflation_opinion = ControversialOpinion::create([
            'name' => 'Inflation',
            'description' => 'The candidate\'s stances about inflation',
            'votes' => 1000,
        ]);

        BallotOpinions::create([
                'ballot_id' => $ballot->id,
                'controversial_opinion_id' => $education_opinion->id,
            ],
        );
        BallotOpinions::create([
                'ballot_id' => $ballot->id,
                'controversial_opinion_id' => $healthcare_opinion->id,
            ],
        );
        BallotOpinions::create([
                'ballot_id' => $ballot->id,
                'controversial_opinion_id' => $security_opinion->id,
            ],
        );
        BallotOpinions::create([
            'ballot_id' => $ballot->id,
            'controversial_opinion_id' => $inflation_opinion->id,
            ],
        );
        ...
        foreach($this->candidates as $candidate_info) {
            ...
            foreach($candidate_info['inflation'] as $opinion) {
                CandidateStance::create([
                    'candidate_id' => $candidate->id,
                    'controversial_opinion_id' => $inflation_opinion->id,
                    'stance_label' => $opinion['name'],
                    'stance_reasoning' => $opinion['stance'],
                ]);
            }
            foreach($candidate_info['education'] as $opinion) {
                CandidateStance::create([
                    'candidate_id' => $candidate->id,
                    'controversial_opinion_id' => $education_opinion->id,
                    'stance_label' => $opinion['name'],
            ...
            foreach($candidate_info['healthcare'] as $opinion) {
                CandidateStance::create([
                    'candidate_id' => $candidate->id,
                    'controversial_opinion_id' => $healthcare_opinion->id,
                    'stance_label' => $opinion['name'],
            ...
            foreach($candidate_info['security'] as $opinion) {
                CandidateStance::create([
                    'candidate_id' => $candidate->id,
                    'controversial_opinion_id' => $security_opinion->id,
                    'stance_label' => $opinion['name'],
            ...
            foreach($candidate_info['personal_education'] as $education) {
                CandidateEducation::create([
                    'candidate_id' => $candidate->id,
                    'school_name' => $education['school_name'],
                    'degree_field' => $education['degree_field'],
                    'degree_type' => $education['degree_type'],
                    'year_received' => $education['year_received'],
                ]);
            }

            foreach($candidate_info['background'] as $background) {
                CandidateBackground::create([
                    'candidate_id' => $candidate->id,
                    'name' => $background['name'],
                    'description' => $background['description'],
                    'year_start' => $background['year_start'],
                    'year_end' => $background['year_end'],
                ]);
            }
        }
    }
